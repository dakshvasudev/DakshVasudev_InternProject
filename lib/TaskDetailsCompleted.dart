...
class TaskDetailsComp extends StatefulWidget {
  const TaskDetailsComp({Key? key}) : super(key: key);

  @override
  State<TaskDetailsComp> createState() => _TaskDetailsCompState();
}
...
class _TaskDetailsCompState extends State<TaskDetailsComp> {
  @override
        ...
        body: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(onPressed: (){}, child: Row(children: [Icon(Icons.check_box),Text('Completed')],),),
            ),
            ElevatedButton(onPressed: (){}, child: const Text('Go to next Task'),),
          ],
        )
    );
  }
